...
{	
	...
	{	
		...
		// construct the DocuSign authentication header. Can use XML or JSON format
		...
		//============================================================================
		// STEP 1 - Make the Login API call to retrieve baseUrl and accountId
		//============================================================================
		...
		//============================================================================
		// STEP 2 - Get Envelope API call
		//============================================================================
		
		url = baseURL + "/envelopes/" + envelopeId;	// append "/envelopes/{envelopeId}" to baseUrl and use in request
		...
		// display results 
		response = getResponseBody(conn);
		System.out.println("-- Get Envelope response --\n\n" + prettyFormat(response, 2));
	} //end main()
