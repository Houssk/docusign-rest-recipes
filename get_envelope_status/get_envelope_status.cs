...
namespace DocuSignAPIWalkthrough02 
{
	public class GetEnvelopeInfo
	{
		public static void Main ()
		{
			...
			try {
				...
				// append "/envelopes/{envelopeId}" to baseURL and use as endpoint for Get Envelope Info api call
		...
		public static void addRequestHeaders(HttpWebRequest request, string email, string password, string intKey)
		{
			...
			string authenticateStr = 
				"<DocuSignCredentials>" + 
					...
					"<IntegratorKey>" + intKey + "</IntegratorKey>" + // global (not passed)
					"</DocuSignCredentials>";
